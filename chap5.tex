...
We are going to drop down the box which currently reads \texttt{contains:} and change it to \texttt{add/removing string:}.  Then we are going to enter \texttt{Change1} into the field on the right.  Your changes should look similar to Figure 11.
