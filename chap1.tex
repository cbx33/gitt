...
When returning to the office, the developers simply push their changes to their “public” space, be it local or to a blessed location, and all of the commits that have been made whilst they are away are then made available to the rest of the team, including all history and changesets.
